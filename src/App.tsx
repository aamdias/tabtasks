...
export default function App() {
  ...
  return (
    <div className="App">
      ...
      <ToDoList />
      <p className="footer"><Key label="Ctrl" /> + <Key label="Shift" /> + <Key label="O" /> can open these tasks!</p>
      <p className="footer without_italic"> Send your feedbacks <a href="https://tally.so/r/w47VGY" target="_blank" className="feedback-link">here</a></p>
    </div>
  )
}
